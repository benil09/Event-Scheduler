...
export async function getEventTypesByUserIdService(hostId) {
    const response = await getEventTypesByUserIdRepo(hostId);
    return response;
}
export async function getEventTypeByEventIdService(eventId) {
...
async function autoGenerateSlotsIfEmpty(userId, eventTypeId, durationMin) {
    ...
    const blockedDates = new Set(exceptions
...
export async function getEventTypePublic(userId, eventSlug) {
...
export async function createEventTypeService(hostId, data) {
...
export async function updateEventTypeService(eventId, data, hostId) {
    const eventType = await findEventTypeByEventIdRepo(eventId);
    if (!eventType) {
        throw notFound("Event not found");
    }
...
export async function deleteEventTypeService(eventId, hostId) {
    const eventType = await findEventTypeByEventIdRepo(eventId);
    if (!eventType) {
        throw notFound("Event not found");
    }
